...
class SetupCallback(Callback):
    ...
    def on_pretrain_routine_start(self, trainer, pl_module):
        if trainer.global_rank == 0:
            ...
            os.makedirs(os.path.join(self.logdir, "testtube", "version_0", "tf"), exist_ok=True)
            os.makedirs(os.path.join(self.logdir, "testtube", "version_0", "media"), exist_ok=True)
    ...
    try:
        ...
        default_logger_cfgs = {
            "wandb": {
                ...
                "params": {
                    "project": "unet-denoiser", 
                    "entity": "vae-lung-tiles",
