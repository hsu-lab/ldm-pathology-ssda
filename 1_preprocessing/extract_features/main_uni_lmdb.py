...
"""
CUDA_VISIBLE_DEVICES=4 python main_uni_lmdb.py \
...
--output_lmdb /workspace/hsuraid/tengyuezhang/diffusion_luad/data_nlst/cond_ablation/cascaded_cross_uni
"""
import os
import lmdb
import io
...
class FeatureExtractor:
    def __init__(self):
        ...
        encoder = encoder_factory('uni_v1', weights_path="/hsuraid/tengyuezhang/tools/trident/hf_weights/uni/pytorch_model.bin").to(self.device).eval()
        self.model = encoder 
